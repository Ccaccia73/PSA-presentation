...
\title[Structural Optimization]{Structural Optimization} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
\textit{claudiogiovanni.caccia@mail.polimi.it} % Your email address
}
